...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    ...
    <link name="author" href="Argenis Oldair Palacios Escobar" />
    <meta name="description" content="Saits">
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="#" title="Saits - Próximamente">
            	<img src="img/logo.png" alt="Saits Proximamente">
            </a>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
      ...
      <br>
		...
		<ul class="connect-us row fade-down">
			<li><a href="https://www.facebook.com/SaitsXYZ/" target="_blank" class="fb tool-tip" title="Facebook"><i class="fa fa-facebook"></i></a></li>
			<li><a href="https://twitter.com/SaitsXYZ" target="_blank" class="twitter tool-tip" title="Twitter"><i class="fa fa-twitter"></i></a></li>
		</ul>
		<!-- Social icons end here -->
		<!-- Footer start here -->
		<footer class="fade-down">        
			<p class="footer-text">&copy; Saits 2016</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="hi@saits.xyz"; // Add your e-mail here
        	if($code!=$captcha){
        ...
        <div class="clearfix cnt-wrap">
          <div class="col-md-4 col-sm-4">
            ...
            <h4>Teléfono</h4>
            <p>Oficina: (+52) 01 7029 2871<br />Móvil: (+52) 01 55 4363 4163</p>
          </div>

          <div class="col-md-4 col-sm-4">      
            <i class="fa fa-envelope-o"></i>
            <h4>Email</h4>
            <p>hi@saits.xyz<br />argenis@saits.xyz</p>
          </div>
          <div class="col-md-4 col-sm-4">
